...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/qasync-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11757&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/qasync-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `qasync` can be installed with:

```
conda install qasync
```

It is possible to list all of the versions of `qasync` available on your platform with:
